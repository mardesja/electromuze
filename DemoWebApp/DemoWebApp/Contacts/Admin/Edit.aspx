<%@ Page Title="ContactsEdit" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="DemoWebApp.Contacts.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="DemoWebApp.Models.Contacts" DefaultMode="Edit" DataKeyNames="ContactId"
